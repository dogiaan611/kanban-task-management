...
### 14. Tính năng Nâng cao (Pro/Enterprise Features)
- `[ ]` Tệp đính kèm (Attachments) vào thẻ (Backend Upload, Frontend UI)
...
- `[ ]` Phân quyền chi tiết (Role-based Access Control - RBAC) ở mức Workspace
